...
import Databaze.DBConnection;
import Databaze.DBconnection2;
			...
			switch(volba)
			{
				case 1:
					...
					while(run2)
					{
						...
						System.out.println("[7] vypis hercu, kteri se podileli na vice filmech");
						...
						System.out.println("[10] nacteni vsech informaci o vybranem filmu ze souboru");
						...
						switch(volba2)
						{
							...
							case 11:
								...
								if (foundMovie != null) {
								    UlozeniPodleNazvu filmSaver = new UlozeniPodleNazvu("hranyfilmy");
							...
							case 12:
						        ...
						        NacteniFilmu.loadFilm("hranyfilmy/" + fileName, hranyFilmList);
								break;
				...
				case 2:
					...
					while(run3)
					{
						...
						System.out.println("[5]  .. vypis filmu");
						System.out.println("[6]  .. vyhledani filmu");
						System.out.println("[7]  .. vypis animatoru, kteri se podileli na vice filmech");
						...
						switch(volba3)
						{
							case 14:
				                ...
				                System.out.println("Zadejte seznam animatoru (oddelte jej carkami):");
							...
							case 15:
								...
								switch (choice) {
								    ...
								    case 3:
								        ...
								        break;
								    case 4:
								        System.out.println("Zadejte novy seznam animatoru (oddelte jej carkami):");
							...
							case 22:
								...
								if (foundMovie != null) {
								    UlozeniPodleNazvu2 filmSaver2 = new UlozeniPodleNazvu2("animovanyFilmy");
							...
							case 23:
						        ...
						        NacteniFilmu2.loadFilm2("animovanyfilmy/" + fileName6, animovanyFilmList);
								break;
				...
				case 3:
			        ...
			        System.out.println("Program byl ukoncen a databaze byly ulozeny do SQL databaze. ");
